...
There is no special case. No separate bootstrap logic. No distinction between "the authorization system" and "the things it authorizes." One recursive pattern: **resources with policies on actions, entities with relationships, all the way down.**
